            ...
            <div className="row">
                <Fade left cascade>
                    <div className="col-md-6 col-auto p-5 my-1">
                        ...
                        <a className="productLink" href="https://builder.biztoolzz.com" target="_blank"><h6 className="text-center mt-2">BUILD BEAUTIFUL WEBSITES</h6></a>
                    </div>
                </Fade>
                <Fade right cascade>
                    <div className="col-md-6 col-auto p-5 my-1">
                ...
                <Fade left cascade>
                    <div className="col-md-6 col-auto p-5 my-1">
                        ...
                        <a className="productLink" href="http://bizzlinc.com/" target="_blank"><h6 className="text-center mt-2">MANAGE YOUR BUSINESS LINKS</h6></a>
                    </div>
                </Fade>
                <Fade right cascade>
                    <div className="col-md-6 col-auto p-5 my-1">
                       ...
                       <a className="productLink" href="https://pm.biztoolzz.com/public/" target="_blank"><h6 className="text-center mt-2">KEEP TRACK OF YOUR PROJECTS</h6></a>
                    </div>
                </Fade>
                <Fade left cascade>
                    <div className="col-md-6 col-auto p-5 my-1">
                        ...
                        <a className="productLink" href="https://qr.biztoolzz.com/" target="_blank"><h6 className="text-center mt-2">SHARE YOUR BUSINESS INFORMATION QUICKLY AND EASILY</h6></a>
                    </div>
                </Fade>
                <Fade right cascade>
                    <div className="col-md-6 col-auto p-5 my-1">
                ...
                <Fade right cascade>
                    <div className="col-md-6 col-auto p-5 my-1">
                        ...
                        <a className="productLink" href="https://resume.biztoolzz.com/" target="_blank"><h6 className="text-center mt-2">CREATE PROFESSIONAL RESUMES FAST AND FREE</h6></a>
                    </div>
                </Fade> 
                <Fade left cascade>
                    <div className="col-md-6 col-auto p-5 my-1">
                        ...
                        <a className="productLink" href="https://hrm.biztoolzz.com/public/" target="_blank"><h6 className="text-center mt-2">
                ...
                <Fade right cascade>
                    <div className="col-md-6 col-auto p-5 my-1">
                        ...
                        <a className="productLink" href="https://marketing.biztoolzz.com/" target="_blank"><h6 className="text-center mt-2">
